<div class="page-header">
        <div class="header-wrapper row m-0">
          ...
          <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="<?= ADMIN_IMG ?>logo/logo.png" alt=""></a></div>
          ...
          <div class="nav-right col-xxl-7 col-xl-6 col-md-7 col-8 pull-right right-header p-0 ms-auto">
            <ul class="nav-menus">
              ...
              <li>                         <span class="header-search">
                  <svg>
                    <use href="<?= ADMIN_ASSETS ?>svg/icon-sprite.svg#search"></use>
                  </svg></span></li>
              <li class="onhover-dropdown">
                <svg>
                  <use href="<?= ADMIN_ASSETS ?>svg/icon-sprite.svg#star"></use>
                </svg>
              ...
              <li>
                <div class="mode">
                  <svg>
                    <use href="<?= ADMIN_ASSETS ?>svg/icon-sprite.svg#moon"></use>
                  </svg>
                </div>
              </li>
              <li class="cart-nav onhover-dropdown">
                <div class="cart-box">
                  <svg>
                    <use href="<?= ADMIN_ASSETS ?>svg/icon-sprite.svg#stroke-ecommerce"></use>
                ...
                <div class="cart-dropdown onhover-show-div">
                  ...
                  <ul>
                    <li>
                      <div class="media"><img class="img-fluid b-r-5 me-3 img-60" src="<?= ADMIN_IMG ?>other-images/cart-img.jpg" alt="">
              ...
              <li class="onhover-dropdown">
                <div class="notification-box">
                  <svg>
                    <use href="<?= ADMIN_ASSETS ?>svg/icon-sprite.svg#notification"></use>
              ...
              <li class="profile-nav onhover-dropdown pe-0 py-0">
                <div class="media profile-media"><img class="b-r-10" src="<?= ADMIN_IMG ?>dashboard/profile.png" alt="">
