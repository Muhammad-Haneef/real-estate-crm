<div class="page-header">
        <div class="header-wrapper row m-0">
          ...
          <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="/"><img class="img-fluid" src="<?= ADMIN_IMG ?>logo.jpg" alt=""></a></div>
            <div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle" data-feather="align-center"></i></div>
          </div>
          <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
            <div class="notification-slider">
              <div class="d-flex h-100"> <img src="<?= ADMIN_IMG ?>giftools.gif" alt="gif">
              ...
              <div class="d-flex h-100"><img src="<?= ADMIN_IMG ?>giftools.gif" alt="gif">
                <h6 class="mb-0 f-w-400"><span class="f-light">Something you love is now on sale! </span></h6><a class="ms-1" href="#" target="_blank">Buy now !</a>
              </div>
            </div>
          </div>
          <div class="nav-right col-xxl-7 col-xl-6 col-md-7 col-8 pull-right right-header p-0 ms-auto">
            <ul class="nav-menus">
              ...
              <li>                         <span class="header-search">
                  <svg>
                    <use href="<?= ADMIN_IMG ?>svg/icon-sprite.svg#search"></use>
                  </svg></span></li>
              <li class="onhover-dropdown">
                <svg>
                  <use href="<?= ADMIN_IMG ?>svg/icon-sprite.svg#star"></use>
                </svg>
              ...
              <li>
                <div class="mode">
                  <svg>
                    <use href="<?= ADMIN_IMG ?>svg/icon-sprite.svg#moon"></use>
                  </svg>
                </div>
              </li>
              <li class="cart-nav onhover-dropdown">
                <div class="cart-box">
                  <svg>
                    <use href="<?= ADMIN_IMG ?>svg/icon-sprite.svg#stroke-ecommerce"></use>
                ...
                <div class="cart-dropdown onhover-show-div">
                  ...
                  <ul>
                    <li>
                      <div class="media"><img class="img-fluid b-r-5 me-3 img-60" src="<?= ADMIN_IMG ?>cart-img.jpg" alt="">
              ...
              <li class="onhover-dropdown">
                <div class="notification-box">
                  <svg>
                    <use href="<?= ADMIN_IMG ?>svg/icon-sprite.svg#notification"></use>
              ...
              <li class="profile-nav onhover-dropdown pe-0 py-0">
                <div class="media profile-media"><img class="b-r-10" src="<?= ADMIN_IMG ?>profile.png" alt="">
          ...
          <script class="result-template" type="text/x-handlebars-template">
            ...
            <div class="ProfileCard-realName">Super Admin</div>
            </div>
            </div>
          </script>
