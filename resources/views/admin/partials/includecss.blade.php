...
<link rel="stylesheet" type="text/css" href="<?= ADMIN_CSS ?>font-awesome.css">
<!-- ico-font-->
<link rel="stylesheet" type="text/css" href="<?= ADMIN_CSS ?>vendors/icofont.css">
<!-- Themify icon-->
<link rel="stylesheet" type="text/css" href="<?= ADMIN_CSS ?>vendors/themify.css">
<!-- Flag icon-->
<link rel="stylesheet" type="text/css" href="<?= ADMIN_CSS ?>vendors/flag-icon.css">
<!-- Feather icon-->
...
<!-- Responsive css-->
<link rel="stylesheet" type="text/css" href="<?= ADMIN_CSS ?>responsive.css">